...
def the_player_score(player, computer, player_score)
  if win?(player, computer)
    player_score += 1
  end
  player_score
...
def the_computer_score(player, computer, computer_score)
...
loop do
  ...
  player_score = the_player_score(choice, computer_choice, player_score)

  computer_score = the_computer_score(choice, computer_choice, computer_score)
